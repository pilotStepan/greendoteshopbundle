...
class CurrencyManagerTest extends TestCase
{
    ...
    /**
     * Regression test: getLocale() previously let SessionNotFoundException
     * propagate uncaught in no-session contexts (CLI, worker), unlike every
     * other method on this class. Must degrade to '' like the rest.
     */
    public function testGetLocaleReturnsEmptyStringWhenNoSessionAvailable(): void
    {
        $this->assertSame('', $this->currencyManager->getLocale());
    }
}
