...
class Upload
{
    ...
    #[ApiProperty]
    #[Groups(['upload:read', 'category_default', 'category:read', 'category:write', 'product_item:read', 'product_list:read', 'product_product:read', 'producer_info:read', 'product_info:write', 'search_result', "SearchProductResultApiModel", 'purchase:read', 'comment:read'])]
