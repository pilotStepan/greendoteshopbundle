...
class ParameterGroup
{
    ...
    #[Groups(['parameter_filtered:read', 'parameter:read', 'parameter_group:read', 'category:read', 'category:write', 'category_parameter_group:read'])]
    private ?ParameterGroupType $type = null;



    #[ORM\Column(nullable: true)]
    #[Groups(['parameter_filtered:read', 'parameter:read', 'parameter_group:read', 'searchable', 'category_parameter_group:read'])]
